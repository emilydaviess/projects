...
INSERT INTO agg_away_fixture(`season_id`,`away_team_id`,`team_name`,`wins`,`losses`,`draws`,`goals_for`,`goals_against`,`ht_score_for`,`ht_score_against`,`ft_score_for`,`ft_score_against`)
SELECT
	a.season_id,
	a.away_team_id, 
	b.name as `team_name`,
...
GROUP BY a.season_id, a.away_team_id
